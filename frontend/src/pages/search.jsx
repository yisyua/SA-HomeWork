    ...
    <>
      <div className="bg-gray-200 min-h-screen">
        <header className="bg-[rgb(46,46,46)] h-[100px] flex items-center justify-between px-20">
          <h1 className="text-white text-3xl font-semibold">查詢課程</h1>
          <button
          ...
          <div className="bg-[rgb(46,46,46)] max-w-[1100px] h-[520px] rounded-lg p-10 flex">
            <div className="flex flex-col w-[350px] space-y-6">
              <div className="flex items-center space-x-4 ml-[40px]">
                <label htmlFor="semester" className="text-white w-14">
                  學期
                </label>
                <input
                  id="semester"
              ...
              <div className="flex items-center space-x-4 ml-[40px]">
                <label htmlFor="program" className="text-white w-14">
                  學制
                </label>
                <input
                  id="program"
              ...
              <div className="flex items-center space-x-4 ml-[40px]">
                <label htmlFor="courseType" className="text-white w-14">
                  課別
                </label>
                <input
                  id="courseType"
              ...
              <div className="flex items-center space-x-4 ml-[40px]">
                <label htmlFor="session" className="text-white w-14">
                  節次
                </label>
                <input
                  id="session"
              ...
              <div className="flex items-center space-x-4 ml-[40px]">
                <label htmlFor="teacher" className="text-white w-14">
                  教師
                </label>
                <input
                  id="teacher"
              ...
              <div className="flex items-center space-x-4 ml-[40px]">
                <label htmlFor="class" className="text-white w-14">
                  班級
                </label>
                <input
                  id="class"
              ...
              <div className="flex items-center space-x-4 ml-[15px]">
                <label htmlFor="classCode" className="text-white w-[80px]">
                  班級代碼
                </label>
                <input
                  id="classCode"
            ...
            <div className="ml-10 flex flex-col space-y-6 ml-[100px]">
              <div className="flex items-center space-x-4">
                <label
                  htmlFor="department"
                  className="text-white w-[80px] ml-[30px] mr-[-30px]"
                >
                  系所
                </label>
                <select
                ...
                >
                  ...
                  <option value="護理助產及婦女健康系">
                    護理助產及婦女健康系
                  </option>
                  <option value="醫護教育暨數位學習系">
                    醫護教育暨數位學習系
                  </option>
                  <option value="中西醫結合護理研究所">
                    中西醫結合護理研究所
                  </option>
                  <option value="中西醫結合護理研究所(舊)">
                    中西醫結合護理研究所(舊)
                  </option>
                  <option value="健康科技學院(不分系)">
                    健康科技學院(不分系)
                  </option>
                  <option value="健康事業管理系">健康事業管理系</option>
                  <option value="資訊管理系">資訊管理系</option>
                  <option value="休閒產業休閒產業與健康促進系">
                    休閒產業休閒產業與健康促進系
                  </option>
                  ...
                  <option value="國際健康科技碩士學位學程">
                    國際健康科技碩士學位學程
                  </option>
                  <option value="人類發展與健康學院(不分系)">
                    人類發展與健康學院(不分系)
                  </option>
                  <option value="嬰幼兒保育系">嬰幼兒保育系</option>
                  <option value="運動保健系">運動保健系</option>
                  <option value="生死與健康心理諮商系">
                    生死與健康心理諮商系
                  </option>
                  <option value="高齡進康暨運動保健技優專班">
                    高齡進康暨運動保健技優專班
                  </option>
                  <option value="智慧健康科技技優專班">
                    智慧健康科技技優專班
                  </option>
                  <option value="人工智慧與健康大數據研究所">
                    人工智慧與健康大數據研究所
                  </option>
                </select>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  <label
                    htmlFor="courseCode"
                    className="text-white w-[80px] ml-[15px] mr-[-15px]"
                  >
                    學分數
                  </label>
                  <input
