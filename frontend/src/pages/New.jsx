        ...
        <div className="bg-gray-200 min-h-screen">
            ...
            <main className="p-8">
                ...
                <div className="flex flex-col items-end">
                    <button
                        className="bg-[rgb(33,94,135)] text-white font-medium text-lg py-3 px-6 rounded-full mb-4 hover:bg-gray-300 hover:text-black transition"
                        onClick={() =>
                            (window.location.href =
                                "https://system10.ntunhs.edu.tw/AcadInfoSystem/Modules/QueryCourse/CourseList.aspx")
                        }
                    >
                        學分規則
                    </button>
                    ...
                    <button className="bg-[rgb(33,94,135)] text-white font-medium text-lg py-3 px-6 rounded-full hover:bg-gray-300 hover:text-black transition">
                        修課建議&其他畢業門檻
                    </button>
                </div>
            </main>
