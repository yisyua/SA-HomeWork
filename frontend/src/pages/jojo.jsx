                ...
                <main className="flex justify-center items-center py-20">
                    <div className="bg-[rgb(33,94,135)] max-w-[1100px] h-[400px] rounded-lg p-10 flex">
                        ...
                        <div className="ml-10 flex justify-start mt-[150px]">
                            <button
                                className="border-2 border-white w-[100px] h-[50px] bg-[rgb(33,94,135)] text-white font-medium text-sm px-6 py-2 rounded-full hover:bg-white hover:text-gray-800"
