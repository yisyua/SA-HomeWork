...
import { validUsers } from "../consts/data";
            ...
            <main className="flex justify-center items-center">
                <div className="flex flex-col items-center bg-[rgba(80,77,77,0.4)] backdrop-blur-lg shadow-lg w-[960px] h-[520px] mt-[30px] rounded-2xl font-semibold">
                    ...
                    <div className="flex flex-col items-center rounded-[20px] bg-[#2e2e2e] w-[900px] h-[340px] overflow-y-auto p-[20px] mt-[30px]">
                        {selectedUser ? (
                            <div className="flex justify-start items-center text-white w-[800px] h-[40px] my-[10px]">
                                <div className="text-center w-[90px] mx-[30px]">
                                    {selectedUser.username}
                                </div>
                                <div className="text-center w-[60px] mx-[30px]">
                                    {selectedUser.role}
                                </div>
                                <div className="text-center w-[90px] mx-[30px]">
                                    {selectedUser.name}
                                </div>
                                <div className="text-center w-[140px] mx-[30px]">
                                    {selectedUser.department}
                                </div>
                                <div className="text-center w-[30px] mx-[20px]">
                                    {selectedUser.grade}
                                </div>
                                <button
