...
export default function SearchResult() {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: isModalOpen || isTeacherModalOpen ? "rgba(0, 0, 0, 0.8)" : "white",
      }}
    >
      <header className="bg-[rgb(33,94,135)] h-[100px] flex items-center justify-between px-20">
        ...
        <button className="bg-[rgb(33,94,135)] border-2 border-white text-white font-medium text-sm px-6 py-2 rounded-full hover:bg-white hover:text-gray-800" onClick={() => navigate("/jojo")}>回到查詢</button>
      </header>
      <main className="flex justify-center items-center py-10">
        <div className="flex flex-col items-center w-[1300px] h-[520px] rounded-3xl bg-gray-400 mb-[60px]">
          ...
          <div className="flex items-center justify-start w-[1200px] h-[50px] bg-[rgb(46,46,46)] text-white rounded-xl mt-6 px-4">
            ...
            <div className="ml-[25px] mr-[40px] flex items-center justify-center">學制</div>
            <div className="ml-[30px] mr-[40px] flex items-center justify-center">年級</div>
            <div className="ml-[0px] mr-[40px] flex items-center justify-center">系所</div>
            <div className="ml-[-20px] mr-[40px] flex items-center justify-center">科目代號</div>
            <div className="ml-[35px] mr-[90px] flex items-center justify-center">課程名稱</div>
            <div className="ml-[35px] mr-[70px] flex items-center justify-center">教師</div>
            <div className="ml-[-35px] mr-[-20px] flex items-center justify-center">學分數</div>
            <div className="ml-[45px] mr-[70px] flex items-center justify-center">課別</div>
            <div className="ml-[-15px] mr-[10px] flex items-center justify-center">地點</div>
            <div className="ml-[30px] mr-[15px] flex items-center justify-center">星期</div>
            <div className="ml-[30px] mr-[0px] flex items-center justify-center">節次</div>
          </div>
            ...
            {filteredCourses.length > 0 ? (
              filteredCourses.map((course) => (
                ...
                >
                  ...
                  <button className="w-[90px] h-[35px] border-2 border-white bg-[rgb(46,46,46)] text-white rounded-full hover:bg-white hover:text-[rgb(46,46,46)] font-semibold transition-all" onClick={() => window.location.href = "https://im.ntunhs.edu.tw/p/412-1054-147.php?Lang=zh-tw"} >{course.course_teacher}</button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      setSelectedClassroomKey(course.classroom_key); // 儲存當前 classroom_key
                      setIsModalOpen(true); // 開啟提醒視窗
                    }}
                  >
                    {course.classroom_key}{course.classroom}
                  </button>
      ...
      {isModalOpen && (
        ...
        >
          <div className="bg-gray-800 text-white p-6 rounded-lg w-[800px] h-[680px]">
            <img
              src={classroomImages[selectedClassroomKey] || "/test/map.png"} // 根據選中的 classroom_key 顯示圖片
              alt="教室地圖"
