  ...
  return (
    <div
      ...
      <header className="bg-[rgb(46,46,46)] h-[100px] flex items-center justify-between px-20">
        ...
        <button className="bg-[rgb(46,46,46)] border-2 border-white text-white font-medium text-sm px-6 py-2 rounded-full hover:bg-white hover:text-gray-800" onClick={() => navigate("/search")}>回到查詢</button>
      </header>
            ...
            {filteredCourses.length > 0 ? (
              filteredCourses.map((course) => (
                ...
                >
                  ...
                  <div className="w-[30px] flex items-center justify-center">{course.classroom}</div>
                  ...
                  <button
                    ...
                    onClick={() => navigate("/edit", { state: course })} 
                  >
                    編輯
                  </button>
                </div>
