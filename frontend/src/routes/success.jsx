...
export default function Success({ onLogout, role }) {
      ...
      <header className="bg-[rgb(33,94,135)] w-full h-28 flex items-center justify-between px-8">
        <h1 className="text-white text-5xl font-bold">功能選擇</h1>
            <div className="flex space-x-6">
                <button className="bg-[rgb(33,94,135)] hover:bg-white border-2 border-white hover:text-gray-800 transition-all text-white font-medium text-lg w-24 h-12 rounded-full" onClick={() => navigate("/")}>登出</button>
            </div>
      </header>
