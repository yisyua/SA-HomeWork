              ...
              <main className="flex justify-center items-center py-10">
                <div className="bg-[rgb(46,46,46)] max-w-[1100px] h-[520px] rounded-lg p-10 flex">
                  ...
                  <div className="ml-10 flex justify-start mt-[200px]">
                    <button className="border-2 border-white w-[100px] h-[50px] bg-[rgb(46,46,46)] text-white font-medium text-sm px-6 py-2 rounded-full hover:bg-white hover:text-gray-800" onClick={handleSubmit}>
                      查詢
                    </button>
                  </div>
                </div>
